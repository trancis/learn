						...
						<div class="col-md-12 column">
							...
							<div class="row clearfix" style="padding: 49px 11px 25px 49px;">
								<div class="col-md-6 column" >
									<font  class="font3" >Current password</font><br><input type="text mytextbox">
								</div>
								<div class="col-md-6 column">
									 <font  class="font3" >New password</font><br><input type="text mytextbox" ><br><br>
									 <font  class="font3" >New password again</font><br><input type="text mytextbox" >
								</div>
							</div>
