...
<div class="myCloseDiv">
	...
	<div class="row clearfix">
		<div class="col-md-10 column" style="padding-top: 25px;">
			<div class="row clearfix">
				...
				<div class="col-md-4 column">
				<div style="display:block;height:21px; clear:both"></div>
				        <div style="padding-top:28px;padding-bottom:10px;"><span style="padding-left: 10px;" class="font3">African</span> <input type="checkbox" id="apperance" class="myCheckBox" checked />
                      <label for="apperance" style="float:right;margin-bottom:0px !important"><span></span></label></div>
                       <div class="linelightgrey" style="width:102%"></div>

                       <div style="padding-top:5px;padding-bottom:8px;"><span style="padding-left: 10px;" class="font3">Mixed</span> <input type="checkbox" id="apperance" class="myCheckBox" style="float:right"/>
                      <label for="apperance" style="float:right ;margin-bottom:0px !important"><span></span></label></div>
                       <div class="linelightgrey" style="width:102%"></div>        
				</div>
			</div>
	...
	<div class="font5 " style="padding-left: 20px;"><a href ="#" class="anchor" data-toggle="modal" data-target="#advanceMenuModal" >Show advanced filtering criteria</a></div><br/>
</div>
</div>
</div>
	                              ...
	                              <div style="padding-bottom:30px;">
                                   ...
                                   <div>
	                                   <div class='text-center'>
		                                <input type="text" class="paddingleft mytextbox topbottom font7" placeholder="Search all actors" style="width:370px; height:42px;">
		                                &nbsp;<button class="myBtn button1 " style="width: 150px;height:42px;">Search</button>
	                                  </div>
	                                  <div style='padding-left:147px;padding-top:35px;'>
		                                <input type="checkbox" id="check" class="myCheckBox" /><label for="check"><span></span></label><span class="font3 " >Search actor names</span>
	                                  </div>

		                              <div style='padding-left:147px;padding-bottom:35px;'>
		                                <input type="checkbox" id="check" class="myCheckBox" /><label for="check"><span></span></label><span class="font3 " >Search resumes</span>
	                                  </div>
                                  </div>
                              </div>    
                        </div>
                        ...
                        <div class="container1">
	                          <div class="row clearfix">
	                              <div style="padding-bottom:30px;">
                                    ...
                                    <div>
	                            <center><div  style="height:170px; display:table">
