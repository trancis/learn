			...
			<nav class="navbar navbar-default font1" style="padding-left:30px" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right" style="padding-right:80px">
						...
						<li>
							<a href = "<?php echo base_url();?>castingfox/loadPage/signup" >Sign up </a>
						</li>
						<li>
	   ...
	   <div class="row clearfix">
		...
		<input type='textbox' class="paddingtopbottom fontsize12" placeholder="Search this site" /><label class="glyphicon glyphicon-search searchicon" style="transform: rotateY(180deg); color:rgb(169,169,169);font-size: 20px;" >&nbsp;</label> </div>
			<ul class="list-unstyled" id="headerMore">
				...
				<li>
					<a href="<?php echo base_url();?>castingfox/loadPage/ABOUT_US" class="orangeanchor fontsize12" >About</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo base_url();?>castingfox/loadPage/contact" class="orangeanchor fontsize12" >Contact us</a>
					</li>
			</ul>
		</div>
