...
<div class="container ">
	<div class="row clearfix">
		...
		<br/>
		<br/>
		<div align="center"><img src="assets/img/logo/AuditionFoxLogo.png" alt="audition fox"/><br/><br/>
			<h2 class="text-center font2">
				<b>FIND YOUR NEXT AUDITION.</b>
			</h2>
			<p class="text-center font6">
				Be your own agent. Access every casting call in Mumbai.
			</p><br/><br/><br/>
			<div class="row clearfix" id="newsLetter">
				<div class="column text-center roundeddiv" style="padding:40px;"><br/>
					<p class="font9">ARE YOU AN ACTOR? SIGN UP FOR AN INVITE.</p>
					 </br>
					 <form method="post" onsubmit="return false;">
		        <div class="row clearfix" >
					 <input type="text" style="width:275px;padding:18px;border-radius:2px;outline:none;border:none"  name="email" id='email' placeholder="Email-Id" class="mytextbox paddingleft font1" />
