					...
					<div class="row clearfix">
						...
						<div class="linelightgrey" style="width:99% !important"></div><br/>
							 ...
							 <div class='padding50'>
							    ...
							    <div class="row clearfix datepickerDiv" style='padding-top:1px;'>
								
											 <input type="text" id="dd" name="dd" class="paddingtopbottom font3 datepicker1" maxlength="2" placeholder="DD" requireVal="true" style="width:50px;">
										
											  <input type="text" id="mm" name="mm" class="paddingtopbottom font3 datepicker1" maxlength="2"placeholder="MM"  requireVal="true" style="width:50px;">
											  <input type="text" id="yy" name="yy" class="paddingtopbottom font3 datepicker1" maxlength="4" placeholder="YYYY"  requireVal="true" style="width:70px;">
