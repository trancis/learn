...
<div class="myCloseDiv">
      ...
      <form action="<?php echo base_url();?>index.php?/auditionfox/login" method="post" id="commentForm">
        ...
        <input type="checkbox" id="remember"><label class="font3">Remember me</label>
        <br>
