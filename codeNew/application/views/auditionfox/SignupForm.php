				...
				<div class="col-md-12 column">
					<div class="row clearfix">
						...
						<div class="col-md-10 column">
							...
							<div class="row clearfix">
								<div class="col-md-12 column">
								<input type="text" id="email" class="paddingtopbottom" id="email" name="email" requireVal="true" placeholder="E-Mail Id" style="width: 270px;height: 38px;"/>&nbsp;&nbsp;
							...
							<div class="col-md-4 column" style="padding: 0px 15px 0px;">
									 <div class="font1">&nbsp;&nbsp;Date of birth</div>
									 &nbsp;&nbsp;<input type="text" class="paddingtopbottom " id="dd" requireVal="true" name="dd" placeholder="DD" style="width:48px;height:38px;"/>
									 <input type="text" class="paddingtopbottom " id="mm" name="mm" requireVal="true" placeholder="MM" style="width:48px;height:38px;"/>
									 <input type="text" class="paddingtopbottom " id="yy" name="yy" requireVal="true" placeholder="YYYY" style="width:59px;height:38px;"/>
								</div>
