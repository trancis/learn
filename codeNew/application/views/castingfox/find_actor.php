...
<div class="container">
  ...
  -webkit-border-radius:5px; ">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style='padding-left:147px;padding-top:35px;'>
                                                            <input type="checkbox" id="check2" class="myCheckBox" />
                                                            <label for="check2"><span></span>
                                                            </label><span class="font3 ">Search actor names</span>
                                                        </div>

                                                        <div style='padding-left:147px;padding-bottom:35px;'>
                                                            <input type="checkbox" id="check1" class="myCheckBox" />
                                                            <label for="check1"><span></span>
                        ...
                        -webkit-border-radius:5px; ">
                                                    ...
                                                    <div>
                                                        <center>
                                                            <div style="height:170px; display:table">
                                                                <span class="font3" style="display: table-cell;vertical-align: middle;"><input type="radio" name="sort" class='myRadio' value="latest"/><span style="padding-right: 55px;">&nbsp;Latest profiles</span></span>
                                                                <span class="font3" style="display: table-cell;vertical-align: middle;"><input type="radio" name="sort" class='myRadio' value="alphabetic"/><span style="padding-right: 55px;" >&nbsp;Name (Alphabetically)</span></span>
                                                                <span class="font3" style="display: table-cell;vertical-align: middle;"><input type="radio" name="sort" class='myRadio' value="random"/><span  >&nbsp;Random</span></span>
                                                            </div>
                                                        </center>
                                                    </div>
                            ...
                            <div id="search">
                               <div id="content"  style="width:890px;padding-left:30px;"class="defaults">
                                ...
                                <?php foreach($data as $row){
                                    ...
                                    <li class="img"><img src="<?php echo base_url();?>assets/img/preload.png" width="160" height="160" data-original="<?php echo base_url(); ?>assets/img/uploads/<?php echo $image; ?>" alt="image">
...
<div class="holder"></div>
                                ...
                                <script type="text/javascript">lazyLoadImages();</script>
...
/*------------------Sorting option of the page --------------------------------*/
 $('input[name=sort]:radio').click( function() {
        var selectedValue = $('input[name=sort]:radio:checked').val();
         $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php?/castingfox/searchBySort/",
 ...
 $('input[name=cc]:radio').change( function() {
var gender = $("input[name=cc]:checked").val();
var height_min_range = $("#min-value").html();
var height_max_range = $("#max-value").html();
var revelance = $("input[name=show]:checked").val();
var data = new Array();
var appearance = new Array();
...
/*---------------------------------------------Appearance on find actor--------------------------------------*/
 $('.appearance:checkbox').change( function() {
    var gender = $("input[name=cc]:checked").val();
    var height_min_range = $("#min-value").html();
var height_max_range = $("#max-value").html();
var revelance = $("input[name=show]:checked").val();
