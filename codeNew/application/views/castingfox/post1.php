	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix" style="background:#fcfcfc;">
		        ...
		        <form action="<?php echo base_url(); ?>index.php?/castingfox/postCasting" method="post">
		                  ...
		                  <div id="radiobox" style="padding-top:20px;" ></div>					
							<div class="row clearfix">
								...
								<div class="col-md-6 column" style='padding-top:20px;'>
									 <div class=" font3"  >Production Company</div>
									  <input type="text" name="productionCompany" class="paddingtopbottom font3" placeholder="e.g Mehboob productions" requireVal="true" style="width:430px;"/>
								</div>
							...
							<div class="row clearfix">
								<div class="col-md-6 column"  style='padding-top:20px;margin-left:-15px;'>
									  ...
									  <textarea rows="5"  name="description" class="paddingtopbottom font3" requireVal="true" style="width:100%"></textarea>
								...
								<div class="col-md-6 column" style='padding-top:20px;float:right;'>
									...
									<textarea rows="5" style="width:100%" name="teamInfo" class="paddingtopbottom font3 " requireVal="true" placeholder="e.g. Written by:Mehboob Khan, Wajahat Mirza Cinematography:Faredoon Irani Studio:Mehboob Productions"></textarea>
								</div>
							</div> <br/><br/>
							</div>
							 ...
							 <div class="font3" style='padding-top:20px;'>Who can view this casting notice?</div>							
							    ...
							    <div style="margin-left:20px;padding-bottom: 35px;">
							       <div><span class="font3">Specify submission instructions</span><span class="font5 font3"><a href="#" class="anchor"><u>(view example)</u></a></span></div>
                                    <textarea rows="5" name="submissionNote" style="width:100%" class="paddingtopbottom font3" placeholder=""  requireVal="true"></textarea>     
							    </div>
							  </div>  
						<div class="linelightgrey" style="width:99% !important"></div><br/>
							 ...
							 <div class='padding50'>
							    ...
							    <div class="row clearfix" style='padding-top:1px;'>
										<div id="exp-date1" width="170px">
										
											 <input type="text" name="dd" class="paddingtopbottom font3" maxlength="2" placeholder="DD" requireVal="true" style="width:50px;" id="day">
										
										
											  <input type="text" name="mm" class="paddingtopbottom font3 " maxlength="2"placeholder="MM"  requireVal="true" style="width:50px;" id="month">
										
										
											  <input type="text" name="yy" class="paddingtopbottom font3" maxlength="4" placeholder="YYYY"  requireVal="true" style="width:70px;" id="year">
									
                                               <input type="text" class="newCalnders">
							    ...
							    <div class="row clearfix">
										...
										<div class="col-md-4 column">
											<div style='padding-top:19px;'><span class="font3" >Call back date </span><span class="font5 font3">(Optional)</span></div>
										...
										<div class="col-md-4 column">
											 <div class="font3" style='padding-top:18px;'>Shoot/Start Date</div>
											  <input type="text" class="paddingtopbottom font3 width" name="shootingDate" placeholder="e.g. October 1st 2014" requireVal="true" style="width:277px !important"/>
										</div>
								</div>
								<div class="row clearfix">
										<div class="col-md-6 column" style="padding-top: 20px;margin-left: -15px;">
										...
										<div class="col-md-6 column" style="padding-top: 20px;padding-right:0px;margin-left:12px;">
											 <span class="font3">Pay rate/Compensation rate</span>
											 <textarea rows="5" style="width:100%" class="paddingtopbottom font3" requireVal="true" name="payRate" placeholder="e.g Rs.12 lakh for 6 months of shooting. Will provide travel and expenses. Will give screen credit and DVD copy"></textarea>
										</div>
									</div>
									<div style='padding-top:20px;padding-bottom:35px;'>
                                       ...
                                       <textarea rows="5" style="width:100%"  name='noteForActor' requireVal="true" class="paddingtopbottom font3" placeholder="e.g. Attach videos of your past performance. Submit photos that match the “look” of the character. Reply with your availability during shooting dates. Be prepared to sing in the audition."></textarea>
                                    </div>
                          ...
                          <div class="linelightgrey" style="width:99% !important"></div><br/>
                             ...
                             <div class='padding50'> 
                                ...
                                <div style="padding-top:20px;padding-bottom:30px;">
                                 ...
                                 <div class="font3 " >Enter descriptions for each character:</div> 
                                 <div id="box">
                                 <div class="charecter_desc leg" style="padding-top:10px;">
                                 <div class="col-md-12 column round" style="background:#f2f2f2;padding-top:10px;">
                                   ...
                                   <div style="padding-left:15px;padding-top:10px;"> <div id="id" class="font3">Role desciption/Note <span class="font5"><a href="#" id="element" class="anchor"  data-container="body" data-toggle="popover" data-placement="bottom" data-content="6767676767666666666" ><u>(view example)</u></a></span></div>
                                     <textarea name="roleDescription" rows="5" style="width:100%"  class="paddingtopbottomfontsize11" requireVal="true" placeholder=""></textarea></div> 
                                  <br/>
                                  ...
                                  <span style="float:left;display:table;"><input type="checkbox" id="nudity" class="myCheckBox" name="nudity" value="1" /><label for="nudity" class="font3" style="font-weight:500 !important;"><span></span>&nbsp;&nbsp; Requires Nudity</label></span>
                                  	 <button class="myBtn button4 font3 up-button" style="color:#333333 !important;background:#f2f2f2 !important" ><div class="moveUp" style="display:inline-block;margin-top:-6px;color:rgb(89,89,89) !important"></div><span>&nbsp;Move up</span></button>
                                  	  <button class="myBtn button4 font3 down-button" style="color:#333333 !important;background:#f2f2f2 !important" ><div class="moveDown" style="display:inline-block;color:rgb(89,89,89) !important"></div><span>&nbsp;Move down</span></button>
                                  	   <span><button class="myBtn button4 font3 deleteMe" style="color:#333333 !important;background:#f2f2f2 !important" ><i class="glyphicon glyphicon-trash" style="color:rgb(89,89,89) !important;"></i>&nbsp;Delete</button></span>
                                  </div>
                                  <br/>
                                 </div>
                                 </div>
                                   ...
                                   <div class="col-md-12 column round" style="background:#f2f2f2;padding-top:10px;">
                                 	<div class="row clearfix">
												<div class="col-md-4 column">
												   <div class="font3">Character2</div>
												   <input type='text' class="paddingtopbottom font3" name="characterName" style="width:250px;height:26px;" requireVal="true" placeholder="e.g.Radha" />
												</div>
												<div class="col-md-2 column">
												   <div class="font3">Gender</div>
                                  ...
                                  <span style="float:left;display:table;"><input type="checkbox" id="nudity" class="myCheckBox" name="nudity" value="1" /><label for="nudity" class="font3" style="font-weight:500 !important;"><span></span>&nbsp;&nbsp; Requires Nudity</label></span>
                                  	 <button class="myBtn button4 font3 up-button" style="color:#333333 !important;background:#f2f2f2 !important" ><div class="moveUp" style="display:inline-block;margin-top:-6px;color:rgb(89,89,89) !important"></div><span>&nbsp;Move up</span></button>
                                  	  <button class="myBtn button4 font3 down-button" style="color:#333333 !important;background:#f2f2f2 !important" ><div class="moveDown" style="display:inline-block;color:rgb(89,89,89) !important"></div><span>&nbsp;Move down</span></button>
                                  	   <span><button class="myBtn button4 font3 deleteMe" style="color:#333333 !important;background:#f2f2f2 !important" ><i class="glyphicon glyphicon-trash" style="color:rgb(89,89,89) !important;"></i>&nbsp;Delete</span></button>
                                  </div>
                                  <br/>
                                 </div>
                                 ...
                                 <div class='text-center' style="padding-bottom:35px;padding-top:20px;"> <button class="myBtn button4 add" style="color:#333333 !important;background:#fcfcfc;" ><i class="glyphicon glyphicon-plus-sign" style="color:rgb(89,89,89) !important; "></i>&nbsp;ADD ANOTHER ROLE</button></div>
                                   <div class="linelightgrey" style="width:99% !important"></div><br/>
                                      <div class="padding25 "><h5>Instructions for the Casting fox team </h5></div>  
                                       ...
                                       <textarea rows="5" style="width:100%"  name="noteCastingFox"class="padding10 " placeholder=""></textarea>
                                       </div><br/><br/>
                                       <div class="linelightgrey" style="width:99% !important"></div><br/>
                                       <div class="text-center">  <button id="post" type="submit" class="myBtn button1 font3" style="width: 235px;">Preview your casting notice</button><br><br><br><br><br></div>
                                         </form>
...
$('.add').click(function(){
var content=$("#box").children('.leg').first().html();
    $("#box").append("<div class='leg'>"+content+"</div>");
    return false;
});
$("#box").on('click', ".deleteMe", function () {
...
$("#exp-date1").click(function(){

$(".newCalnders").datepicker();
...
$(".newCalnders").change(function(){


var dayval= $(".newCalnders").val();
 
var dyarry=dayval.split("/");
    $("#year").attr("value",dyarry[2]);
    $("#month").attr("value",dyarry[1]);
    $("#day").attr("value",dyarry[0]);
